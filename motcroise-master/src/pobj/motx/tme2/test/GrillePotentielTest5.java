...
public class GrillePotentielTest5 {
	...
	@Test
	public void testMedium() throws FileNotFoundException, IOException {
	...
	@Test
	public void testEasy() throws FileNotFoundException, IOException {
		...
		System.out.println(gp.getMotsPot().get(0).size());
		System.out.println(gp.getMotsPot().get(1).size());
		System.out.println(gp.getMotsPot().get(2).size());
	...
	@Test
	public void testHard() throws FileNotFoundException, IOException {
